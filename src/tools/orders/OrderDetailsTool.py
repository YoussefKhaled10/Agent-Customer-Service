...
class OrderDetailsTool(ToolInterface):
    ...
    def definition(self) -> ToolDefinition:
        return ToolDefinition(
            name="order_details",
            description="Get full details of one order owned by the authenticated customer.",
            input_schema={
                "type": "object",
                "properties": {
            ...
            is_idempotent=True,
            tags=("orders", "details", "sensitive_read"),
        )
    ...
    def execute(self, **arguments: Any) -> dict[str, Any]:
        ...
        with self.session_factory() as session:
            ...
            return {"found": True, "order": serialize_order_details(order)}
